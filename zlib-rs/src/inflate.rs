...
impl State<'_> {
    ...
    fn dispatch(&mut self) -> ReturnCode {
        ...
        let ret = #[cfg_attr(feature = "__internal-loop-match", loop_match)]
        'label: loop {
            mode = 'blk: {
                match mode {
                    Mode::Head => {
                        ...
                        if (self.wrap & 2) != 0 && self.bit_reader.hold() == 0x8b1f {
                            ...
                            let mut b0 = self.bit_reader.bits(8) as u8;
                            let mut b1 = (self.bit_reader.hold() >> 8) as u8;
                        ...
                        let mut len = self.bit_reader.bits(4) as u8 + 8;
                    ...
                    Mode::TypeDo => {
                        ...
                        let mut bits = self.bit_reader.bits(2);
                        match bits {
                            0b00 => {
                    ...
                    Mode::Stored => {
                        ...
                        let mut hold = self.bit_reader.bits(32) as u32;
                    ...
                    Mode::Match => {
                        ...
                        'match_: loop {
                            ...
                            let mut left = self.writer.remaining();
                            let mut copy = self.writer.len();
